...
class CalculateMealNutrient(private val preferences: Preferences) {
    ...
    operator fun invoke(trackedFoods: List<TrackedFood>): Result {
        ...
        val carbsGoal = (caloryGoal * userInfo.carbRatio / 4f).roundToInt() // 1g of carb has 4 kilocalories, get the total amount of carb for a given day
