package com.aghogho.tracker_presentation.search.components
...
import com.aghogho.tracker_presentation.search.SearchEvent
import com.aghogho.tracker_presentation.search.SearchViewModel
...
fun SearchScreen(
    ...
    Column(
        ...
        Text(
            text = stringResource(id = com.aghogho.core.R.string.add_meal),
    ...
    Box(
        ...
        when {
            ...
            state.trackableFood.isEmpty() -> {
                Text(
                    text = stringResource(id = com.aghogho.core.R.string.no_results),
