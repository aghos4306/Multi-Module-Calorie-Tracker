...
fun NutrientsBar(
    ...
    protein: Int,
    fat: Int,
    calories: Int,              // how much calories we consume daily
    calorieGoal: Int,            //amount of calorie we aim to consume.
    ...
    Canvas(modifier = modifier) {
        if (calories <= calorieGoal) {
            val carbsWidth = carbWidthRatio.value * size.width      //size.width is the whole width of the canvas
