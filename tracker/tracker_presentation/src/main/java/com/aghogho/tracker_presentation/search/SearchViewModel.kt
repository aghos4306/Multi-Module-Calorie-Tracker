package com.aghogho.tracker_presentation.search
...
import com.aghogho.tracker_domain.use_case.TrackerUseCases
            ...
            trackerUseCases
                ...
                .onSuccess { foods ->
                    state = state.copy(
                        ...
                        isSearching = false,
                        query = ""   //reset query to empty string
                    )
                }
                .onFailure {
                    ...
                    _uiEvent.send(
                        UiEvent.ShowSnackbar(
                            UiText.StringResource(com.aghogho.core.R.string.error_something_went_wrong)
                        )
                    )
                }
        }
